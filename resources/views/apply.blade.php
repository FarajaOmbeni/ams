            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                      ...
                      <li class="nav-item"><a style="color: #000;" class="nav-link" href="#contact">Contact</a></li>
                      <li class="nav-item"><a style="color: #000;" class="nav-link" href="login">Login AMS</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        <!--REGISTRATION FORM-->
        <section class="page-section" id="reg">
                      ...
                      <div class="row">
                        <div class="col">
                          <select name="nationality" class="form-control" required>
                            <option hidden selected>Nationality</option>
                        ...
                        <div class="col">
                          <select class="form-control dropdown" id="religion" name="religion" required>
                            <option hidden selected>Religion</option>
